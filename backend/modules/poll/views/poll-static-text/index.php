...
<div class="poll-static-text-index">
    ...
    <p>
        Ця сторінка містить перелік підмов, для яких можна редагувати статичний HTML-блок зі статистикою
        та мета-теги сторінок опитувань. Оберіть підмову, щоб налаштувати потрібні тексти.
    </p>
