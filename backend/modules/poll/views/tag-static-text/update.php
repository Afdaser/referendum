        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <p>
                    ...
                    Дозволено використовувати ті самі змінні, що й у статичному тексті, а для пагінації також доступна змінна @page (включно з окремим H1).
                </p>
                <?= $form->field($model, 'heading')
                    ->textInput(['maxlength' => true])
                    ->hint('Значення потрапляє у головний H1 на першій сторінці тегу. Можна вставляти змінні на кшталт @tag.'); ?>
                <?= $form->field($model, 'paginated_heading')
                    ->textInput(['maxlength' => true])
                    ->hint('Окремий H1 для сторінок пагінації тегу. Працює змінна @page.'); ?>
