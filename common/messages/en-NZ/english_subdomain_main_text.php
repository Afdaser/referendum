...
// Окремий SEO-текст для англомовного піддомену: можна редагувати без ризику змінити базовий переклад.
// Щоб не нашкодити, лишайте ключове слово return — шаблон очікує рядок із текстом.
return <<<HTML
...
<p>Anonymous survey on the Internet is considered the most effective, because there is a great chance that the person will answer frankly. After all, when surveys are conducted on the street, it is unlikely that the person will actually answer sincerely.</p>
<p>Here you can conduct a survey yourself for themes and ask other users. You can also participate in other polls or just find out various interesting facts while browsing the news feed. Which poll is important and which is not also you choose, by assigning a rating to each of the polls and ranking them on the site for them.</p>
