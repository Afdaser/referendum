...
//    const MAIN_DOMAIN = 'https://online-statistics.org';
    ...
    /**
     * Перелік змінних для шаблонів статичного тексту опитувань.
     */
    public static function getStaticTextTokens(): array
    {
        return [
            '@title' => 'Назва опитування.',
            '@date' => 'Дата створення опитування.',
            '@votes' => 'Загальна кількість голосів.',
            '@reg' => 'Кількість голосів від зареєстрованих користувачів.',
            '@guest' => 'Кількість голосів від гостей.',
            '@comments' => 'Кількість коментарів до опитування.',
            '@tags' => 'Перелік тем у вигляді посилань (може бути порожнім).',
            '@mostanswer' => 'Найпопулярніша відповідь.',
            '@mostvotes' => 'Кількість голосів за найпопулярнішу відповідь.',
            '@mostpercent' => 'Відсоток голосів за найпопулярнішу відповідь.',
        ];
    }
