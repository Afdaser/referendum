...
- CAPTCHA генерує новий код при кожному оновленні зображення та суворо перевіряє введене значення.
- Обліковий запис створюється лише після успішної валідації форми.
