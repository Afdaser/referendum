...
Для кожної URL‑адреси вказується тег `lastmod`, що відображає дату останнього оновлення відповідного опитування або тегу. При визначенні цієї дати враховуються редагування самого опитування, додавання коментарів чи голосів та зміни пов'язаних тегів.
