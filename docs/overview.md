...
Головний домен-агрегатор `referendum.social` працює як загальна вітрина: він відображає
останні опитування з усіх мовних піддоменів без редіректу і показує повний набір тегів до кожного опитування. Посилання на
опитування і теги завжди ведуть на піддомен тієї мови, якою створено конкретний матеріал. Канонічне посилання на головній
сторінці фіксується на `https://referendum.social/`, щоб уникнути дублювання контенту, а звернення на `www.referendum.social`
одразу перенаправляються на кореневий домен без префікса.

Списки тегів продовжують отримувати власні канонічні посилання, що ведуть на відповідний мовний піддомен.
