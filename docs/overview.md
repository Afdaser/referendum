...
Попередня спроба асинхронного підключення окремих таблиць стилів призводила до внутрішньої помилки сервера.
Наразі всі файли CSS знову завантажуються стандартно через `AppAsset`, що забезпечує стабільну роботу сайту.
