...
- Перезавантаження CAPTCHA тепер генерує новий код при кожному кліку, а зображення оновлюється без перезавантаження сторінки.
- Зображення CAPTCHA відображається коректно завдяки використанню абсолютного шляху до дії `/site/captcha`.
...
- Перед відправкою форми користувач повинен підтвердити Правила та умови сайту.
