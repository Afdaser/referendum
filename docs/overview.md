...
Головна сторінка та списки тегів отримують власні канонічні посилання, що ведуть на відповідний мовний піддомен.
...
параметра `page`. Канонічне посилання тепер веде безпосередньо на адресу профілю (`https://<locale>.referendum.social/Profile/<id>`),
а не на головну сторінку піддомену, що усуває дублювання й уточнює сигнал для індексації. Тайтл лишається у форматі «{нікнейм} - Referendum»,
