...
Сторінки опитувань формують канонічні посилання на піддомен, що відповідає мові опитування. Якщо сторінка відкрита на
основному домені `https://referendum.social/`, canonical збігається з поточним хостом і редірект більше не виконується.
Наприклад, звернення до `https://referendum.social/poll/573` залишиться на головному домені та віддасть canonical на цю ж
адресу.

Головна сторінка покладається на глобальне формування canonical у макетах, тож контролер більше не примусово встановлює
посилання і не виконує жодних редіректів. Списки тегів і сторінки опитувань зберігають канонічні посилання на актуальний
хост без вимушених перенаправлень, що полегшує роботу з локалізаціями та тестуванням.
