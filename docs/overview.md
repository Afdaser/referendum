...
- на головних сторінках відображаються опитування з найбільшою кількістю користувацьких голосів за останні шість місяців.
- фільтр періоду підтримує варіанти: за день, за неділю, за місяць, за півроку та за рік.
