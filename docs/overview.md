...
Профілі користувачів на сторінці `/Profile/<id>` отримали мікророзмітку `ProfilePage` з головною сутністю `Person`. У структуровані дані входять ПІБ, нікнейм, електронна пошта (якщо користувач зробив її публічною), короткий опис з профілю, абсолютна адреса сторінки, зображення аватара та окремі лічильники для кількості опитувань і коментарів. Це допомагає пошуковикам краще розуміти зміст профілю і показувати розширені результати у видачі.
