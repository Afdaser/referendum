...
- заголовок формату «Досліджуйте опитування {tag} — живі результати | Referendum»;
- опис з кількістю опитувань: «Отримайте доступ до живих результатів {count} опитувань {tag} — опитувань щодо ставлень і думок. Перевіряйте результати та голосуйте.»
