...
`<meta name="robots" content="noindex, follow">`. Це забороняє індексацію профілів пошуковими системами, але дозволяє
перехід за посиланнями всередині профілю. Налаштування виконується на рівні контролера, тож мета-тег додається для будь-якої
сторінки профілю незалежно від параметра `page`. Додатково профіль отримує канонічне посилання на головну сторінку відповідного
мовного піддомену та тайтл у форматі «{нікнейм} - Referendum» з описом «Polls and opinion about everything - take part in polls
and discussion: vote, write comments, suggest vote options or create your own polls. 📊 Dive in! 🌟».
