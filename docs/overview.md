...
Всі публічні сторінки профілів користувачів (`/site/userProfile/<id>`) та їхні сторінки пагінації тепер віддають мета-тег
...
сторінки профілю незалежно від параметра `page`.
