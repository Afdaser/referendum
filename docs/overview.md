...
Форма реєстрації оновлена для роботи з Yii 2. Логін та email перевіряються на унікальність, а зображення CAPTCHA генерує новий код при кожному натисканні. Введений користувачем код тепер правильно валідовується.
