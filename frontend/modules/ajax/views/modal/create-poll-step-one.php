...
<?php /*
  ...
  <form method="post" action="/poll/<? php if (!$model->id): ?>createPoll<? php else: ?>editPoll<? php endif; ?>" >
 *
 *<div class="modal-content" id="new_poll<?= $model->id?$model->id:0?>">
 *
 *
  <!-- Modal AJAX 1 -->
  <?php /* */ ?>
...
<?php /*
  <div class="modal new_poll" id="new_poll<?= $model->id?$model->id:0?>" tabindex="-1" role="dialog" aria-hidden="true">
  <?php /*
<form method="post" action="/poll/<?= empty($model->id) ? 'createPoll' : 'editPoll'; ?>">
 *
 * <form method="post" action="<?= Url::toRoute(['/ajax/modal/store-poll-form']); ?>">
 * <form method="post" action="<?= Url::toRoute(['/ajax/modal/store-poll-form']); ?>">
 *
 *
...
<?php $form = ActiveForm::begin(['id' => 'poll-form', 'action'=> Url::toRoute(['/ajax/modal/store-poll-form']),]); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content" id="poll_modal_content_step0">
            ...
            <div class="modal-body">
                ...
                <div class="input_text_modal_b middle_text_input_b">
                    <?php /* <textarea name="Poll[describe]"><?= $model->describe; ?></textarea> /* */ ?>
...
<?php /* */ ?>
     ...
     * </div>
     *
     *     <div class="modal new_poll poll" id="new_poll_next_step<?= $model->id ? $model->id : 0 ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
     *
     *
     *  */ ?>
...
alert ('~/frontend/modules/ajax/views/modal/create-poll-step-one.php');
