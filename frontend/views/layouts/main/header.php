...
<header class="header">
    <div class="container">
        <?php // Обгортаємо елементи хедера у гнучкий контейнер для сучасного адаптивного компонування. ?>
        <div class="row header_row">
            ...
            <?php // Блок керування мовою та пошуком зберігає поточний функціонал без змін логіки. ?>
